#!/bin/bash
: '
Measures bonds, angles, and dihedrals in ../structure_files/(bonds|angles|dihedrals).ndx for the specified trajectory and tpr file and stores the distributions, averages and standard deviations in $loc/(bonds|angles|dihedrals)_mapped/*
INPUTS:
     $1: trajectory file
     $2: tpr file
     $3: location to store results
'
