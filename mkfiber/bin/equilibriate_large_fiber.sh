...
gmx grompp -f mdp/emin2.mdp -c ../tmp/${OUTPUT_NAME}_rmwater.gro -r ../tmp/${OUTPUT_NAME}_rmwater.gro -p ${TOPOLOGY_PATH} -o ../tmp/em2_${OUTPUT_NAME}.tpr  -maxwarn 1 > ../logs/em2_${OUTPUT_NAME}_grompp.out
...
gmx grompp -f mdp/nvt_long.mdp -c ../tmp/em2_${OUTPUT_NAME}.gro -r ../tmp/em2_${OUTPUT_NAME}.gro -p ${TOPOLOGY_PATH} -o ../tmp/nvt_${OUTPUT_NAME}.tpr  -maxwarn 1 > ../logs/em2_${OUTPUT_NAME}_grompp.out
gmx mdrun -deffnm ../tmp/nvt_${OUTPUT_NAME} -nt $NCORES -gpu_id $GPU_ID > ../logs/nvt_${OUTPUT_NAME}_run.out
printf '16\n0\n' | gmx energy -f ../tmp/nvt_${OUTPUT_NAME}.edr -o ../output/nvt_${OUTPUT_NAME}_temp.xvg

#Run unconstrained NVT equilibration
#Run constrained NVT equilibration
cat << EOF > "mdp/nvt_long2.mdp"
title                   = Constrained Fiber NVT equilibration 
...
gmx grompp -f mdp/nvt_long2.mdp -c ../tmp/nvt_${OUTPUT_NAME}.gro -p ${TOPOLOGY_PATH} -o ../tmp/nvt_${OUTPUT_NAME}2.tpr \
...
printf '15\n0\n' | gmx energy -f ../tmp/nvt_${OUTPUT_NAME}2.edr -o ../output/nvt_${OUTPUT_NAME}2_temp.xvg

#Run NPT equilibration
cat << EOF > "mdp/npt_long.mdp"
...
gmx grompp -f mdp/npt_long.mdp -c ../tmp/nvt_${OUTPUT_NAME}2.gro -t ../tmp/nvt_${OUTPUT_NAME}2.cpt -p ${TOPOLOGY_PATH} -o ../tmp/npt_long_${OUTPUT_NAME}.tpr \
  -maxwarn 1 > ../logs/npt_long_${OUTPUT_NAME}_grompp.out
cp ../tmp/npt_long_${OUTPUT_NAME}.tpr ../system/${OUTPUT_NAME}/npt_${OUTPUT_NAME}.tpr
cp ${TOPOLOGY_PATH} ../system/${OUTPUT_NAME}/${OUTPUT_NAME}.top
